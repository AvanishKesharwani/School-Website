        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-white/80 max-w-2xl mx-auto text-lg md:text-xl font-light">
              Your gateway to academic guidelines, communication, and circulars for Manka Public School.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-2xl text-center">
          ...
          >
            ...
            <p className="text-brand-gray text-base leading-relaxed mb-8 max-w-md">
              We are currently compiling resources, parent circulars, and feedback guidelines for this section. Please check back shortly for full updates.
            </p>
