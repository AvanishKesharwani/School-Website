...
export default function StudentLife({ content }: { content?: any }) {
  ...
  return (
    <section ref={containerRef} className="bg-brand-white text-brand-navy overflow-hidden">
      <div className="h-screen w-full flex flex-col justify-center pt-24 pb-12">
        <div className="container mx-auto px-6 md:px-12 mb-8 shrink-0">
        ...
        <EditableText
          as="p"
          className="text-lg text-brand-gray max-w-2xl"
          sectionSlug="student-life-section"
          field="description"
      ...
      <div className="relative w-full overflow-hidden flex-grow flex items-center">
        <div 
          ref={scrollRef} 
          className="flex gap-8 px-6 md:px-12 w-max items-center h-full"
        >
          {sections.map((section, index) => (
            <div 
              key={index}
              className="w-[85vw] md:w-[60vw] lg:w-[40vw] h-[60vh] shrink-0 relative rounded-3xl overflow-hidden group"
            >
              <EditableImage
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 md:p-12 pointer-events-none">
                <span className="text-brand-yellow font-bold tracking-wider text-sm uppercase mb-3 block">
                  0{index + 1}
                </span>
                <div className="pointer-events-auto">
                  ...
                  <EditableText
                    as="p"
                    className="text-brand-white/80 text-lg leading-relaxed max-w-lg"
                    sectionSlug="student-life-section"
