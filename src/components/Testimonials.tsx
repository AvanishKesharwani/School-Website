...
export default function Testimonials({ content }: { content?: any }) {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 bg-brand-navy text-brand-white overflow-hidden relative">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="max-w-4xl mx-auto relative min-h-[380px] sm:min-h-[340px] md:min-h-[300px]">
