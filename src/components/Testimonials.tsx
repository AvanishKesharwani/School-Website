...
export default function Testimonials({ content }: { content?: any }) {
  ...
  return (
    <section className="py-24 bg-brand-navy text-brand-white overflow-hidden relative">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="max-w-4xl mx-auto relative h-[300px]">
          <AnimatePresence initial={false} custom={direction}>
            ...
            >
              <div className="bg-brand-white/5 backdrop-blur-sm border border-brand-white/10 p-10 md:p-12 rounded-3xl shadow-2xl relative w-full pointer-events-auto">
                <Quote className="w-10 h-10 text-brand-yellow mb-6 mx-auto opacity-50" />
                <EditableText
                  as="p"
                  className="text-xl md:text-2xl text-brand-white/90 leading-relaxed mb-8 font-medium"
                  sectionSlug="testimonials-section"
